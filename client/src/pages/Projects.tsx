      ...
      <div className="flex max-sm:flex-col sm:items-center gap-4 px-4 py-2">
        ...
        <div className="flex items-center justify-end gap-3 flex-1 text-xs sm:text-sm">
          ...
          <button
            ...
            className="bg-blue-600 hover:bg-blue-500 px-3.5 py-1 flex items-center gap-2 rounded"
          >
          ...
          <button
            ...
            className="bg-indigo-600 hover:bg-indigo-500 px-3.5 py-1 flex items-center gap-2 rounded"
          >
            {project.isPublished ? (
              <EyeOffIcon size={16} />
            ) : (
